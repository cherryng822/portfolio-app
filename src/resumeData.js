let resumeData = {
  imagebaseurl: "",
  name: "Cherry Ng",
  role: "Frontend Developer/Illustrator/Tutor",
  coverPhotos: [
    {
      PhotoSource: "/images/coverphoto01.png",
      HeaderText: "Slasher Based in Hong Kong",
      Description: "Frontend Developer/Presentation Designer/Illustrator",
    },
    {
      PhotoSource: "/images/coverphoto02.png",
      HeaderText: "Potential Unlocking",
      Description: "Previously an experieneced Mathematices Tutor",
    },
    {
      PhotoSource: "/images/coverphoto03.png",
      HeaderText: "Reformation in Progress",
      Description:
        "The purpose of life is to live it, to taste and experience it to the utmost, to reach out eagerly and without fear for newer or richer experience.” ― Eleanor Roosevelt",
    },
  ],
  linkedinId: "cherry-ng-yuen-ching",
  roleDescription:
  ...
  socialLinks: [
    {
      name: "linkedin",
      url: "https://www.linkedin.com/in/cherry-ng-yuen-ching",
      className: "fab fa-linkedin-in",
    },
    {
      name: "github",
      url: "https://github.com/cherryng822",
      className: "fab fa-github",
    },
  ],
  aboutme:
    "Dedicated and ingenious Mathematics tutor with over 5 years of experience in teaching HKDSE curriculum. Possess strong communication and team management skills with a team of 6 tutors in a SME. Adept at improving efficiency and increasing quality with state-of-the-art technology.",
  address: "Hong Kong",
  website: "https://github.com/cherryng822",
  education: [
    {
      UniversityName: "Chinese University of Hong Kong",
      specialization: "BSc in Statistics with minor in Psychology",
      MonthOfPassing: "Jul",
      YearOfPassing: "2015",
    },
    {
      UniversityName: "FreeCodeCamp.org",
      specialization: "Front End Libraries Certificates",
      MonthOfPassing: "Nov",
      YearOfPassing: "2020",
    },
  ],
  work: [
    {
      CompanyName: "Linear and Creative Learning Centre",
      specialization: "Senior Mathematics Tutor",
      YearOfEntering: "2015",
      YearOfLeaving: "2020",
      Achievements:
        "Familiar with HKDSE Mathematics & M1 curriculum, leader of a 6-tutor team, and actively involved in event planning",
    },
  ],
  techSkills: [
    { skillname: "HTML" },
  ...
  softSkills: [
    ...
    { skillname: "Motivating & Inspiring" },
  ...
  testimonials: [
    {
      description: "Responsive Wed Design",
      name: "FreeCodeCamp",
    },
    {
